-- -----------------------------------------------------------------------------
-- Course Completers for Hazing Prevention 101 (with custom fields)
-- Context: Site
-- Name: Course Completers (Hazing Prevention 101)†
-- Summary:
-- 	<h4>Students completing <i>Hazing Prevention 101™ Course – College Edition</i></h4>
...
AND c.idnumber REGEXP '^101(-[0-9]{4}){0,1}(-[0-9]{2}){0,1}$'
